            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <a className="text-slate-300 hover:text-white" href="mailto:support@ramtechsolutions.com">support@ramtechsolutions.com</a>
                </div>
                <div className="flex items-center gap-4">
                  <span className="material-symbols-outlined text-yellow-400">call</span>
                  <a className="text-slate-300 hover:text-white" href="tel:+15551234567">+1 (555) 123-4567</a>
                </div>
                <div className="flex items-center gap-4">
                  <span className="material-symbols-outlined text-yellow-400">sms</span>
                  <a className="text-slate-300 hover:text-white" href="https://wa.me/15559876543">+1 (555) 987-6543</a>
                </div>
              </div>

              <h3 className="text-2xl font-bold mt-8">Follow Us</h3>
              <div className="flex gap-6">
                <a className="text-slate-400 hover:text-white" href="#" aria-label="Instagram">
                  <svg className="size-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.85s-.011 3.584-.069 4.85c-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07s-3.584-.012-4.85-.07c-3.252-.148-4.771-1.691-4.919-4.919-.058-1.265-.069-1.645-.069-4.85s.011-3.584.069-4.85c.149-3.225 1.664-4.771 4.919-4.919 1.266-.058 1.644-.07 4.85-.07zm0-2.163c-3.273 0-3.692.012-4.981.072-4.354.2-6.135 1.98-6.335 6.335-.06 1.288-.072 1.708-.072 4.981s.012 3.692.072 4.981c.2 4.354 1.981 6.135 6.335 6.335.06 1.288.072 1.708.072 4.981s-.012-3.692-.072-4.981c-.2-4.354-1.98-6.135-6.335-6.335-1.288-.06-1.708-.072-4.981-.072zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.162 6.162 6.162 6.162-2.759 6.162-6.162-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4s1.791-4 4-4 4 1.79 4 4-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.441 1.441 1.441 1.441-.645 1.441-1.441-.645-1.44-1.441-1.44z"></path></svg>
                </a>
                ...
                <a className="text-slate-400 hover:text-white" href="#" aria-label="YouTube">
