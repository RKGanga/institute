export const metadata = {
  title: 'Terms and Conditions - Upskillo',
  description: 'Read Upskillo terms and conditions.'
}
      ...
      <section className="px-4 sm:px-6 md:px-10 lg:px-16 py-12 sm:py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="rounded-xl border border-gray-800 bg-gray-800/60 p-6 md:p-8 shadow-lg">
            ...
            <p>
              These Terms and Conditions ("Terms") govern your use of the Upskillo website and services. By accessing or using our services,
            ...
            <p>
              All content, materials, and trademarks on this site are the property of Upskillo or its licensors and are protected by applicable
              intellectual property laws. You may not copy, reproduce, or distribute content without prior written permission.
            </p>

            <h2>Limitation of Liability</h2>
            <p>
              To the maximum extent permitted by law, Upskillo shall not be liable for any indirect, incidental, special, consequential, or
            ...
            <h2>Contact Us</h2>
            <p>
              If you have any questions about these Terms, please contact us at support@upskillo.com
            </p>
            </div>
          </div>
        </div>
